...
<div id="wrapper" >
	<div id="maincontentcontainer" >
		<div id="maincontent">
          ...
          <nav class="nav-collapse" >
			...
			<div class="section group">
				...
				<div id="photoCredit"><strong>The Forks Market</strong> &bull; Credit: Brent Bellamy</div>
				</div>
			</div>
		...
		<div class="section group content">
				...
				<a href="">BC vs AB</a><br />
				<a href="">W vs SO</a><br />
				<a href="">2nd Championship Match<br />(If necessary)</a><br />
				</div>
				</div>
				<div class="col span_2_of_3"  id="contentArea">
					
					<h2>ladies stepladder</h2>
				<h4>BC vs AB<br />Meagan Gallicano vs.  Jennifer Baker</span></h4>
				<h5>Meagan Gallicano</h5>
				<table width="100%" border="0" cellspacing="0" cellpadding="0"  style="border:1px solid black;height:70px;">
...
<br />
				...
				<h4>Winner vs. SO<br />Winner vs. Tracey Ormiston</span></h4>
				<h5>Winner</h5>
				<table width="100%" border="0" cellspacing="0" cellpadding="0"  style="border:1px solid black;height:70px;">
		<tr style="height:20px;">
				<td style="border:1px solid black;"> </td>
