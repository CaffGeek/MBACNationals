    ...
    <div class="col-sm-2 hidden-print" data-ng-controller="ResultsController">
        <ul class="sidebarNav">
            ...
            <li><a ui-sref="stepladder()" data-ng-click="viewStepladder()">STEPLADDER</a></li>
             <p style="font-family:verdana, sans-serif;font-size:12px;"><strong>ATTENTION:</strong> There is an error in the Tournament Mens Singles - QC & MB Bowlers, in Game 14. Which gives QC an extra 4 points.</p> 
