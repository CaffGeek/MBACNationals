...
<asp:Content ID="BodyContent" ContentPlaceHolderID="BodyPlaceholder" runat="server">    
    ...
    <br />
        ...
        <h2>Follow Us</h2>
        <h3>Newsletter</h3>
<!-- SendinBlue Signup Form HTML Code --><iframe width="200" height="82" src="https://my.sendinblue.com/users/subscribe/js_id/2dew5/id/1" frameborder="0" scrolling="auto" allowfullscreen style="display: block;margin-left: auto;margin-right: auto;max-width: 100%;"></iframe><!-- End : SendinBlue Signup Form HTML Code -->
