	...
	<div id="maincontentcontainer" >
		...
		<div class="section group content">
				...
				<div class="col span_2_of_3"  id="contentArea">
					...
					<h2>mens stepladder</h2>
				<h4>QC vs AB<br />Sylvain Bercier vs.  Aaron Arndt</span></h4>
				<h5>Sylvain Bercier</h5>
...
<br />
				...
				<h4>Winner vs. SO<br />Winner vs. Connor Dorion</span></h4>
				<h5>Winner</h5>
				<table width="100%" border="0" cellspacing="0" cellpadding="0"  style="border:1px solid black;height:70px;">
		<tr style="height:20px;">
				<td style="border:1px solid black;">&nbsp;</td>
