	...
	<div id="maincontentcontainer" >
		<div id="maincontent">
			...
			<div class="section group">
				...
				<div id="socialLinks">Join Us:&nbsp;&nbsp;<a href="https://www.facebook.com/MBAofCanada" target="_blank"><img src="images/facebook_icon.png" /></a><!--&nbsp;&nbsp;<img src="images/twitter_icon.png" />--></div>
				<div id="navigation">
		...
		<div class="section group content">
				...
				<div class="col span_2_of_3" id="contentArea">
					...
					<h2>PHOTOS</h2>
					<p>Check back soon for new information!</p>
