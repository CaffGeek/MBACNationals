      ...
      <div class="row">
        ...
        <h2>centres</h2>
      		<h4 id="cloverdale">Clover Lanes - Cloverdale</h4>
						...
						<div class="container">
							<div class="row">
								...
								For more information, check out their website: <a href="http://surreybowling.com" target="_blank">http://surreybowling.com</a></p>
								</div>
				      		</div>
				      	</div>
      		<h4 id="scottsdale">Scottsdale Lanes - Surrey</h4>
						...
						<div class="container">
							<div class="row">
								...
								For more information, check out their website: <a href="http://www.scottsdalelanes.com" target="_blank">http://www.scottsdalelanes.com</a></p>
      		...
      		<h4 id="willowbrook">Willowbrook Lanes - Willowbrook</h4>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-3 col-sm-3 centreLogo"><img src="images/Willowbrook.jpg" alt="Willowbrook Lanes" /></div>
								<div class="col-md-9 col-sm-9 centreDetails">
