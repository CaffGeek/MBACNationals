...
<asp:Content ID="HeaderContent" ContentPlaceHolderID="HeaderPlaceholder" runat="server">
    ...
    <div id="photoCredit"><strong>Fireworks from the Canadian Museum of Civilization</strong> &bull; Credit: Frank.Defalco - Wikimedia Commons</div>
</asp:Content>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="BodyPlaceholder" runat="server">
    <div class="row" data-ng-controller="ScheduleController">
        ...
        <div class="col-md-10">
            ...
            Click here to <a href="https://calendar.google.com/calendar/ical/p7vg564jka9r90qrb4n6unp928%40group.calendar.google.com/public/basic.ics">Download Schedule</a>
