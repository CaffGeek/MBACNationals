...
<asp:Content ID="HeaderContent" ContentPlaceHolderID="HeaderPlaceholder" runat="server">
    ...
    <div id="photoCredit"><strong>Boulevard Lake</strong> &bull; Credit: Derek Silver, Wikimedia Commons</div>
</asp:Content>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="BodyPlaceholder" runat="server">
    <div class="row" data-ng-controller="ScheduleController">
        ...
        <div class="col-md-10">
            ...
            Click here to <a href="https://calendar.google.com/calendar/ical/01bjjf3a3beq7h3ol9rlu4b648%40group.calendar.google.com/public/basic.ics">Download Schedule</a>
