...
namespace MBACNationals
{
    ...
    public static class ScheduleBuilder
    {
        ...
        public static void TournamentMenSingle(ICommandQueries commandQueries, MessageDispatcher dispatcher)
        {
            ...
            {
                build(++game, "MB", "QC", lane = 13, "A"), build(game, "BC", "AB", lane += 2, "B"), build(game, "SK", "NL", lane += 2, "C"), build(game, "NO", "SO", lane += 2, "D"),
                build(++game, "NL", "SO", lane = 13, "A"), build(game, "SK", "NO", lane += 2, "B"), build(game, "QC", "AB", lane += 2, "C"), build(game, "MB", "BC", lane += 2, "D"),
                build(++game, "SK", "AB", lane = 13, "A"), build(game, "MB", "SO", lane += 2, "B"), build(game, "NO", "BC", lane += 2, "C"), build(game, "QC", "NL", lane += 2, "D"),
                build(++game, "BC", "NL", lane = 13, "A"), build(game, "NO", "QC", lane += 2, "B"), build(game, "MB", "SK", lane += 2, "C"), build(game, "SO", "AB", lane += 2, "D"),
                build(++game, "NO", "MB", lane = 13, "A"), build(game, "AB", "NL", lane += 2, "B"), build(game, "BC", "SO", lane += 2, "C"), build(game, "SK", "QC", lane += 2, "D"),
                build(++game, "QC", "BC", lane = 13, "A"), build(game, "SO", "SK", lane += 2, "B"), build(game, "AB", "MB", lane += 2, "C"), build(game, "NL", "NO", lane += 2, "D"),
                build(++game, "AB", "NO", lane = 13, "A"), build(game, "NL", "MB", lane += 2, "B"), build(game, "SO", "QC", lane += 2, "C"), build(game, "BC", "SK", lane += 2, "D"),
            });

            build = MatchBuilder(commandQueries, division, BowlingCentre.Superior, isPoa);
            commands.AddRange(new List<SaveMatch>
            {
                build(++game, "AB", "BC", lane = 09, "A"), build(game, "QC", "MB", lane += 2, "B"), build(game, "SO", "NO", lane += 2, "C"), build(game, "NL", "SK", lane += 2, "D"),
                build(++game, "NO", "SK", lane = 09, "A"), build(game, "SO", "NL", lane += 2, "B"), build(game, "BC", "MB", lane += 2, "C"), build(game, "AB", "QC", lane += 2, "D"),
                build(++game, "SO", "MB", lane = 09, "A"), build(game, "AB", "SK", lane += 2, "B"), build(game, "NL", "QC", lane += 2, "C"), build(game, "BC", "NO", lane += 2, "D"),
                build(++game, "QC", "NO", lane = 09, "A"), build(game, "NL", "BC", lane += 2, "B"), build(game, "AB", "SO", lane += 2, "C"), build(game, "SK", "MB", lane += 2, "D"),
                build(++game, "NL", "AB", lane = 09, "A"), build(game, "MB", "NO", lane += 2, "B"), build(game, "QC", "SK", lane += 2, "C"), build(game, "SO", "BC", lane += 2, "D"),
                build(++game, "SK", "SO", lane = 09, "A"), build(game, "BC", "QC", lane += 2, "B"), build(game, "NO", "NL", lane += 2, "C"), build(game, "MB", "AB", lane += 2, "D"),
                build(++game, "MB", "NL", lane = 09, "A"), build(game, "NO", "AB", lane += 2, "B"), build(game, "SK", "BC", lane += 2, "C"), build(game, "QC", "SO", lane += 2, "D"),
            });

            build = MatchBuilder(commandQueries, division, BowlingCentre.Marios, isPoa);
            commands.AddRange(new List<SaveMatch>
            {
                build(++game, "SK", "NL", lane = 33, "A"), build(game, "NO", "SO", lane += 2, "B"), build(game, "BC", "AB", lane += 2, "C"), build(game, "MB", "QC", lane += 2, "D"),
                build(++game, "QC", "AB", lane = 33, "A"), build(game, "MB", "BC", lane += 2, "B"), build(game, "SK", "NO", lane += 2, "C"), build(game, "NL", "SO", lane += 2, "D"),
                build(++game, "NO", "BC", lane = 33, "A"), build(game, "QC", "NL", lane += 2, "B"), build(game, "MB", "SO", lane += 2, "C"), build(game, "SK", "AB", lane += 2, "D"),
                build(++game, "MB", "SK", lane = 33, "A"), build(game, "SO", "AB", lane += 2, "B"), build(game, "NO", "QC", lane += 2, "C"), build(game, "BC", "NL", lane += 2, "D"),
                build(++game, "BC", "SO", lane = 33, "A"), build(game, "SK", "QC", lane += 2, "B"), build(game, "AB", "NL", lane += 2, "C"), build(game, "NO", "MB", lane += 2, "D"),
                build(++game, "AB", "MB", lane = 33, "A"), build(game, "NL", "NO", lane += 2, "B"), build(game, "SO", "SK", lane += 2, "C"), build(game, "QC", "BC", lane += 2, "D"),
                build(++game, "SO", "QC", lane = 33, "A"), build(game, "BC", "SK", lane += 2, "B"), build(game, "NL", "MB", lane += 2, "C"), build(game, "AB", "NO", lane += 2, "D"),
            });
        ...
        public static void TournamentMen(ICommandQueries commandQueries, MessageDispatcher dispatcher)
        {
            ...
            commands.AddRange(new List<SaveMatch>
            {
                ...
                build(++game, "NO", "AB", lane = 21, "A"), build(game, "NL", "SK", lane += 2, "B"), build(game, "BC", "QC", lane += 2, "C"), build(game, "SO", "MB", lane += 2, "D"),
                build(++game, "NL", "QC", lane = 21, "A"), build(game, "SO", "AB", lane += 2, "B"), build(game, "SK", "MB", lane += 2, "C"), build(game, "BC", "NO", lane += 2, "D"),
                build(++game, "MB", "NO", lane = 21, "A"), build(game, "SK", "BC", lane += 2, "B"), build(game, "SO", "NL", lane += 2, "C"), build(game, "AB", "QC", lane += 2, "D"),
                build(++game, "SK", "SO", lane = 21, "A"), build(game, "QC", "NO", lane += 2, "B"), build(game, "MB", "AB", lane += 2, "C"), build(game, "NL", "BC", lane += 2, "D"),
                build(++game, "BC", "MB", lane = 21, "A"), build(game, "AB", "NL", lane += 2, "B"), build(game, "QC", "SO", lane += 2, "C"), build(game, "NO", "SK", lane += 2, "D"),
            });

            build = MatchBuilder(commandQueries, division, BowlingCentre.Galaxy, isPoa);
            commands.AddRange(new List<SaveMatch>
            {
                build(++game, "QC", "SK", lane = 13, "A"), build(game, "NO", "SO", lane += 2, "B"), build(game, "AB", "BC", lane += 2, "C"), build(game, "MB", "NL", lane += 2, "D"),
                build(++game, "NO", "NL", lane = 13, "A"), build(game, "AB", "SK", lane += 2, "B"), build(game, "QC", "MB", lane += 2, "C"), build(game, "BC", "SO", lane += 2, "D"),
                build(++game, "QC", "BC", lane = 13, "A"), build(game, "MB", "SO", lane += 2, "B"), build(game, "SK", "NL", lane += 2, "C"), build(game, "AB", "NO", lane += 2, "D"),
                build(++game, "MB", "SK", lane = 13, "A"), build(game, "NO", "BC", lane += 2, "B"), build(game, "AB", "SO", lane += 2, "C"), build(game, "QC", "NL", lane += 2, "D"),
                build(++game, "NL", "SO", lane = 13, "A"), build(game, "QC", "AB", lane += 2, "B"), build(game, "BC", "SK", lane += 2, "C"), build(game, "NO", "MB", lane += 2, "D"),
                build(++game, "AB", "MB", lane = 13, "A"), build(game, "BC", "NL", lane += 2, "B"), build(game, "NO", "QC", lane += 2, "C"), build(game, "SO", "SK", lane += 2, "D"),
            });

            build = MatchBuilder(commandQueries, division, BowlingCentre.Marios, isPoa);
            commands.AddRange(new List<SaveMatch>
            {
                build(++game, "BC", "AB", lane = 25, "A"), build(game, "NL", "MB", lane += 2, "B"), build(game, "SK", "QC", lane += 2, "C"), build(game, "SO", "NO", lane += 2, "D"),
                build(++game, "SO", "QC", lane = 25, "A"), build(game, "SK", "NO", lane += 2, "B"), build(game, "NL", "AB", lane += 2, "C"), build(game, "MB", "BC", lane += 2, "D"),
                build(++game, "MB", "NL", lane = 25, "A"), build(game, "AB", "BC", lane += 2, "B"), build(game, "NO", "SO", lane += 2, "C"), build(game, "QC", "SK", lane += 2, "D"),
                build(++game, "NO", "SK", lane = 25, "A"), build(game, "QC", "SO", lane += 2, "B"), build(game, "BC", "MB", lane += 2, "C"), build(game, "AB", "NL", lane += 2, "D"),
                build(++game, "NL", "BC", lane = 25, "A"), build(game, "MB", "AB", lane += 2, "B"), build(game, "SK", "SO", lane += 2, "C"), build(game, "QC", "NO", lane += 2, "D"),
                build(++game, "AB", "QC", lane = 25, "A"), build(game, "SO", "NL", lane += 2, "B"), build(game, "MB", "NO", lane += 2, "C"), build(game, "SK", "BC", lane += 2, "D"),
            });

            build = MatchBuilder(commandQueries, division, BowlingCentre.Superior, isPoa);
            commands.AddRange(new List<SaveMatch>
            {
                build(++game, "BC", "NO", lane = 03, "A"), build(game, "SK", "MB", lane += 2, "B"), build(game, "NL", "QC", lane += 2, "C"), build(game, "SO", "AB", lane += 2, "D"),
                build(++game, "SO", "MB", lane = 03, "A"), build(game, "BC", "QC", lane += 2, "B"), build(game, "NO", "AB", lane += 2, "C"), build(game, "NL", "SK", lane += 2, "D"),
                build(++game, "SK", "AB", lane = 03, "A"), build(game, "NL", "NO", lane += 2, "B"), build(game, "SO", "BC", lane += 2, "C"), build(game, "MB", "QC", lane += 2, "D"),
            });
        ...
        public static void TournamentLadies(ICommandQueries commandQueries, MessageDispatcher dispatcher)
        {
            ...
            commands.AddRange(new List<SaveMatch>
            {
                build(++game, "SO", "BC", lane = 13, "A"), build(game, "MB", "QC", lane += 2, "B"), build(game, "NL", "NO", lane += 2, "C"), build(game, "SK", "AB", lane += 2, "D"),
                build(++game, "NO", "AB", lane = 13, "A"), build(game, "NL", "SK", lane += 2, "B"), build(game, "BC", "QC", lane += 2, "C"), build(game, "SO", "MB", lane += 2, "D"),
                build(++game, "NL", "QC", lane = 13, "A"), build(game, "SO", "AB", lane += 2, "B"), build(game, "SK", "MB", lane += 2, "C"), build(game, "BC", "NO", lane += 2, "D"),
                build(++game, "MB", "NO", lane = 13, "A"), build(game, "SK", "BC", lane += 2, "B"), build(game, "SO", "NL", lane += 2, "C"), build(game, "AB", "QC", lane += 2, "D"),
                build(++game, "SK", "SO", lane = 13, "A"), build(game, "QC", "NO", lane += 2, "B"), build(game, "MB", "AB", lane += 2, "C"), build(game, "NL", "BC", lane += 2, "D"),
                build(++game, "BC", "MB", lane = 13, "A"), build(game, "AB", "NL", lane += 2, "B"), build(game, "QC", "SO", lane += 2, "C"), build(game, "NO", "SK", lane += 2, "D"),
            });

            build = MatchBuilder(commandQueries, division, BowlingCentre.Superior, isPoa);
            commands.AddRange(new List<SaveMatch>
            {
                build(++game, "QC", "SK", lane = 01, "A"), build(game, "NO", "SO", lane += 2, "B"), build(game, "AB", "BC", lane += 2, "C"), build(game, "MB", "NL", lane += 2, "D"),
                build(++game, "NO", "NL", lane = 01, "A"), build(game, "AB", "SK", lane += 2, "B"), build(game, "QC", "MB", lane += 2, "C"), build(game, "BC", "SO", lane += 2, "D"),
                build(++game, "QC", "BC", lane = 01, "A"), build(game, "MB", "SO", lane += 2, "B"), build(game, "SK", "NL", lane += 2, "C"), build(game, "AB", "NO", lane += 2, "D"),
                build(++game, "MB", "SK", lane = 01, "A"), build(game, "NO", "BC", lane += 2, "B"), build(game, "AB", "SO", lane += 2, "C"), build(game, "QC", "NL", lane += 2, "D"),
                build(++game, "NL", "SO", lane = 01, "A"), build(game, "QC", "AB", lane += 2, "B"), build(game, "BC", "SK", lane += 2, "C"), build(game, "NO", "MB", lane += 2, "D"),
                build(++game, "AB", "MB", lane = 01, "A"), build(game, "BC", "NL", lane += 2, "B"), build(game, "NO", "QC", lane += 2, "C"), build(game, "SO", "SK", lane += 2, "D"),
            });

            build = MatchBuilder(commandQueries, division, BowlingCentre.Galaxy, isPoa);
            commands.AddRange(new List<SaveMatch>
            {
                build(++game, "BC", "AB", lane = 29, "A"), build(game, "NL", "MB", lane += 2, "B"), build(game, "SK", "QC", lane += 2, "C"), build(game, "SO", "NO", lane += 2, "D"),
                build(++game, "SO", "QC", lane = 29, "A"), build(game, "SK", "NO", lane += 2, "B"), build(game, "NL", "AB", lane += 2, "C"), build(game, "MB", "BC", lane += 2, "D"),
                build(++game, "MB", "NL", lane = 29, "A"), build(game, "AB", "BC", lane += 2, "B"), build(game, "NO", "SO", lane += 2, "C"), build(game, "QC", "SK", lane += 2, "D"),
                build(++game, "NO", "SK", lane = 29, "A"), build(game, "QC", "SO", lane += 2, "B"), build(game, "BC", "MB", lane += 2, "C"), build(game, "AB", "NL", lane += 2, "D"),
                build(++game, "NL", "BC", lane = 29, "A"), build(game, "MB", "AB", lane += 2, "B"), build(game, "SK", "SO", lane += 2, "C"), build(game, "QC", "NO", lane += 2, "D"),
                build(++game, "AB", "QC", lane = 29, "A"), build(game, "SO", "NL", lane += 2, "B"), build(game, "MB", "NO", lane += 2, "C"), build(game, "SK", "BC", lane += 2, "D"),
            });

            build = MatchBuilder(commandQueries, division, BowlingCentre.Marios, isPoa);
            commands.AddRange(new List<SaveMatch>
            {
                build(++game, "BC", "NO", lane = 27, "A"), build(game, "SK", "MB", lane += 2, "B"), build(game, "NL", "QC", lane += 2, "C"), build(game, "SO", "AB", lane += 2, "D"),
                build(++game, "SO", "MB", lane = 27, "A"), build(game, "BC", "QC", lane += 2, "B"), build(game, "NO", "AB", lane += 2, "C"), build(game, "NL", "SK", lane += 2, "D"),
                build(++game, "SK", "AB", lane = 27, "A"), build(game, "NL", "NO", lane += 2, "B"), build(game, "SO", "BC", lane += 2, "C"), build(game, "MB", "QC", lane += 2, "D"),
            });
        ...
        public static void TeachingMen(ICommandQueries commandQueries, MessageDispatcher dispatcher)
        {
            ...
            commands.AddRange(new List<SaveMatch>
            {
                ...
                build(++game, "NO", "QC", lane = 27, "A"), build(game, "SO", "NL", lane += 2, "B"), build(game, "MB", "AB", lane += 2, "C"), build(game, "BC", "SK", lane += 2, "D"),
                build(++game, "SO", "AB", lane = 27, "A"), build(game, "BC", "QC", lane += 2, "B"), build(game, "NL", "SK", lane += 2, "C"), build(game, "MB", "NO", lane += 2, "D"),
                build(++game, "SK", "NO", lane = 27, "A"), build(game, "NL", "MB", lane += 2, "B"), build(game, "BC", "SO", lane += 2, "C"), build(game, "QC", "AB", lane += 2, "D"),
                build(++game, "NL", "BC", lane = 27, "A"), build(game, "AB", "NO", lane += 2, "B"), build(game, "SK", "QC", lane += 2, "C"), build(game, "SO", "MB", lane += 2, "D"),
                build(++game, "MB", "SK", lane = 27, "A"), build(game, "QC", "SO", lane += 2, "B"), build(game, "AB", "BC", lane += 2, "C"), build(game, "NO", "NL", lane += 2, "D"),
            });

            build = MatchBuilder(commandQueries, division, BowlingCentre.Galaxy, isPoa);
            commands.AddRange(new List<SaveMatch>
            {
                build(++game, "AB", "NL", lane = 29, "A"), build(game, "NO", "BC", lane += 2, "B"), build(game, "QC", "MB", lane += 2, "C"), build(game, "SK", "SO", lane += 2, "D"),
                build(++game, "NO", "SO", lane = 29, "A"), build(game, "QC", "NL", lane += 2, "B"), build(game, "AB", "SK", lane += 2, "C"), build(game, "MB", "BC", lane += 2, "D"),
                build(++game, "AB", "MB", lane = 29, "A"), build(game, "SK", "BC", lane += 2, "B"), build(game, "NL", "SO", lane += 2, "C"), build(game, "QC", "NO", lane += 2, "D"),
                build(++game, "SK", "NL", lane = 29, "A"), build(game, "NO", "MB", lane += 2, "B"), build(game, "QC", "BC", lane += 2, "C"), build(game, "AB", "SO", lane += 2, "D"),
                build(++game, "SO", "BC", lane = 29, "A"), build(game, "AB", "QC", lane += 2, "B"), build(game, "MB", "NL", lane += 2, "C"), build(game, "NO", "SK", lane += 2, "D"),
                build(++game, "QC", "SK", lane = 29, "A"), build(game, "MB", "SO", lane += 2, "B"), build(game, "NO", "AB", lane += 2, "C"), build(game, "BC", "NL", lane += 2, "D"),
            });

            build = MatchBuilder(commandQueries, division, BowlingCentre.Galaxy, isPoa);
            commands.AddRange(new List<SaveMatch>
            {
                build(++game, "MB", "QC", lane = 21, "A"), build(game, "SO", "SK", lane += 2, "B"), build(game, "NL", "AB", lane += 2, "C"), build(game, "BC", "NO", lane += 2, "D"),
                build(++game, "BC", "AB", lane = 21, "A"), build(game, "NL", "NO", lane += 2, "B"), build(game, "SO", "QC", lane += 2, "C"), build(game, "SK", "MB", lane += 2, "D"),
                build(++game, "SK", "SO", lane = 21, "A"), build(game, "QC", "MB", lane += 2, "B"), build(game, "NO", "BC", lane += 2, "C"), build(game, "AB", "NL", lane += 2, "D"),
                build(++game, "NO", "NL", lane = 21, "A"), build(game, "AB", "BC", lane += 2, "B"), build(game, "MB", "SK", lane += 2, "C"), build(game, "QC", "SO", lane += 2, "D"),
                build(++game, "SO", "MB", lane = 21, "A"), build(game, "SK", "QC", lane += 2, "B"), build(game, "NL", "BC", lane += 2, "C"), build(game, "AB", "NO", lane += 2, "D"),
                build(++game, "QC", "AB", lane = 21, "A"), build(game, "BC", "SO", lane += 2, "B"), build(game, "SK", "NO", lane += 2, "C"), build(game, "NL", "MB", lane += 2, "D"),
            });

            build = MatchBuilder(commandQueries, division, BowlingCentre.Galaxy, isPoa);
            commands.AddRange(new List<SaveMatch>
            {
                build(++game, "MB", "NO", lane = 13, "A"), build(game, "NL", "SK", lane += 2, "B"), build(game, "SO", "AB", lane += 2, "C"), build(game, "BC", "QC", lane += 2, "D"),
                build(++game, "BC", "SK", lane = 13, "A"), build(game, "MB", "AB", lane += 2, "B"), build(game, "NO", "QC", lane += 2, "C"), build(game, "SO", "NL", lane += 2, "D"),
                build(++game, "NL", "QC", lane = 13, "A"), build(game, "SO", "NO", lane += 2, "B"), build(game, "BC", "MB", lane += 2, "C"), build(game, "SK", "AB", lane += 2, "D"),
            });
        ...
        public static void TeachingLadies(ICommandQueries commandQueries, MessageDispatcher dispatcher)
        {
            ...
            commands.AddRange(new List<SaveMatch>
            {
                ...
                build(++game, "NO", "QC", lane = 03, "A"), build(game, "SO", "NL", lane += 2, "B"), build(game, "MB", "AB", lane += 2, "C"), build(game, "BC", "SK", lane += 2, "D"),
                build(++game, "SO", "AB", lane = 03, "A"), build(game, "BC", "QC", lane += 2, "B"), build(game, "NL", "SK", lane += 2, "C"), build(game, "MB", "NO", lane += 2, "D"),
                build(++game, "SK", "NO", lane = 03, "A"), build(game, "NL", "MB", lane += 2, "B"), build(game, "BC", "SO", lane += 2, "C"), build(game, "QC", "AB", lane += 2, "D"),
                build(++game, "NL", "BC", lane = 03, "A"), build(game, "AB", "NO", lane += 2, "B"), build(game, "SK", "QC", lane += 2, "C"), build(game, "SO", "MB", lane += 2, "D"),
                build(++game, "MB", "SK", lane = 03, "A"), build(game, "QC", "SO", lane += 2, "B"), build(game, "AB", "BC", lane += 2, "C"), build(game, "NO", "NL", lane += 2, "D"),
            });

            build = MatchBuilder(commandQueries, division, BowlingCentre.Marios, isPoa);
            commands.AddRange(new List<SaveMatch>
            {
                build(++game, "AB", "NL", lane = 27, "A"), build(game, "NO", "BC", lane += 2, "B"), build(game, "QC", "MB", lane += 2, "C"), build(game, "SK", "SO", lane += 2, "D"),
                build(++game, "NO", "SO", lane = 27, "A"), build(game, "QC", "NL", lane += 2, "B"), build(game, "AB", "SK", lane += 2, "C"), build(game, "MB", "BC", lane += 2, "D"),
                build(++game, "AB", "MB", lane = 27, "A"), build(game, "SK", "BC", lane += 2, "B"), build(game, "NL", "SO", lane += 2, "C"), build(game, "QC", "NO", lane += 2, "D"),
                build(++game, "SK", "NL", lane = 27, "A"), build(game, "NO", "MB", lane += 2, "B"), build(game, "QC", "BC", lane += 2, "C"), build(game, "AB", "SO", lane += 2, "D"),
                build(++game, "SO", "BC", lane = 27, "A"), build(game, "AB", "QC", lane += 2, "B"), build(game, "MB", "NL", lane += 2, "C"), build(game, "NO", "SK", lane += 2, "D"),
            ...
            commands.AddRange(new List<SaveMatch>
            {
                ...
                build(++game, "BC", "AB", lane = 13, "A"), build(game, "NL", "NO", lane += 2, "B"), build(game, "SO", "QC", lane += 2, "C"), build(game, "SK", "MB", lane += 2, "D"),
                build(++game, "SK", "SO", lane = 13, "A"), build(game, "QC", "MB", lane += 2, "B"), build(game, "NO", "BC", lane += 2, "C"), build(game, "AB", "NL", lane += 2, "D"),
                build(++game, "NO", "NL", lane = 13, "A"), build(game, "AB", "BC", lane += 2, "B"), build(game, "MB", "SK", lane += 2, "C"), build(game, "QC", "SO", lane += 2, "D"),
                build(++game, "SO", "MB", lane = 13, "A"), build(game, "SK", "QC", lane += 2, "B"), build(game, "NL", "BC", lane += 2, "C"), build(game, "AB", "NO", lane += 2, "D"),
            ...
            commands.AddRange(new List<SaveMatch>
            {
                ...
                build(++game, "BC", "SK", lane = 29, "A"), build(game, "MB", "AB", lane += 2, "B"), build(game, "NO", "QC", lane += 2, "C"), build(game, "SO", "NL", lane += 2, "D"),
                build(++game, "NL", "QC", lane = 29, "A"), build(game, "SO", "NO", lane += 2, "B"), build(game, "BC", "MB", lane += 2, "C"), build(game, "SK", "AB", lane += 2, "D"),
            });
        ...
        public static void Seniors(ICommandQueries commandQueries, MessageDispatcher dispatcher)
        {
            ...
            commands.AddRange(new List<SaveMatch>
            {
                build(++game, "MB", "BC", lane = 29, "A"), build(game, "QC", "NL", lane += 2, "B"), build(game, "NO", "SK", lane += 2, "C"), build(game, "AB", "SO", lane += 2, "D"),
                build(++game, "SK", "SO", lane = 29, "A"), build(game, "NO", "AB", lane += 2, "B"), build(game, "BC", "NL", lane += 2, "C"), build(game, "MB", "QC", lane += 2, "D"),
                build(++game, "NO", "NL", lane = 29, "A"), build(game, "MB", "SO", lane += 2, "B"), build(game, "AB", "QC", lane += 2, "C"), build(game, "BC", "SK", lane += 2, "D"),
                build(++game, "QC", "SK", lane = 29, "A"), build(game, "AB", "BC", lane += 2, "B"), build(game, "MB", "NO", lane += 2, "C"), build(game, "SO", "NL", lane += 2, "D"),
                build(++game, "AB", "MB", lane = 29, "A"), build(game, "NL", "SK", lane += 2, "B"), build(game, "QC", "SO", lane += 2, "C"), build(game, "NO", "BC", lane += 2, "D"),
                build(++game, "BC", "QC", lane = 29, "A"), build(game, "SO", "NO", lane += 2, "B"), build(game, "NL", "MB", lane += 2, "C"), build(game, "SK", "AB", lane += 2, "D"),
            });

            build = MatchBuilder(commandQueries, division, BowlingCentre.Galaxy, isPoa);
            commands.AddRange(new List<SaveMatch>
            {
                build(++game, "NL", "AB", lane = 21, "A"), build(game, "SK", "MB", lane += 2, "B"), build(game, "SO", "BC", lane += 2, "C"), build(game, "QC", "NO", lane += 2, "D"),
                build(++game, "SK", "NO", lane = 21, "A"), build(game, "SO", "AB", lane += 2, "B"), build(game, "NL", "QC", lane += 2, "C"), build(game, "BC", "MB", lane += 2, "D"),
                build(++game, "NL", "BC", lane = 21, "A"), build(game, "QC", "MB", lane += 2, "B"), build(game, "AB", "NO", lane += 2, "C"), build(game, "SO", "SK", lane += 2, "D"),
                build(++game, "QC", "AB", lane = 21, "A"), build(game, "SK", "BC", lane += 2, "B"), build(game, "SO", "MB", lane += 2, "C"), build(game, "NL", "NO", lane += 2, "D"),
                build(++game, "NO", "MB", lane = 21, "A"), build(game, "NL", "SO", lane += 2, "B"), build(game, "BC", "AB", lane += 2, "C"), build(game, "SK", "QC", lane += 2, "D"),
                build(++game, "SO", "QC", lane = 21, "A"), build(game, "BC", "NO", lane += 2, "B"), build(game, "SK", "NL", lane += 2, "C"), build(game, "MB", "AB", lane += 2, "D"),
            });

            build = MatchBuilder(commandQueries, division, BowlingCentre.Superior, isPoa);
            commands.AddRange(new List<SaveMatch>
            {
                build(++game, "BC", "SO", lane = 03, "A"), build(game, "NO", "QC", lane += 2, "B"), build(game, "AB", "NL", lane += 2, "C"), build(game, "MB", "SK", lane += 2, "D"),
                build(++game, "MB", "NL", lane = 03, "A"), build(game, "AB", "SK", lane += 2, "B"), build(game, "NO", "SO", lane += 2, "C"), build(game, "QC", "BC", lane += 2, "D"),
                build(++game, "QC", "NO", lane = 03, "A"), build(game, "SO", "BC", lane += 2, "B"), build(game, "SK", "MB", lane += 2, "C"), build(game, "NL", "AB", lane += 2, "D"),
                build(++game, "SK", "AB", lane = 03, "A"), build(game, "NL", "MB", lane += 2, "B"), build(game, "BC", "QC", lane += 2, "C"), build(game, "SO", "NO", lane += 2, "D"),
                build(++game, "NO", "BC", lane = 03, "A"), build(game, "QC", "SO", lane += 2, "B"), build(game, "AB", "MB", lane += 2, "C"), build(game, "NL", "SK", lane += 2, "D"),
                build(++game, "SO", "NL", lane = 03, "A"), build(game, "MB", "NO", lane += 2, "B"), build(game, "QC", "SK", lane += 2, "C"), build(game, "AB", "BC", lane += 2, "D"),
            });

            build = MatchBuilder(commandQueries, division, BowlingCentre.Galaxy, isPoa);
            commands.AddRange(new List<SaveMatch>
            {
                build(++game, "BC", "SK", lane = 21, "A"), build(game, "AB", "QC", lane += 2, "B"), build(game, "NO", "NL", lane += 2, "C"), build(game, "MB", "SO", lane += 2, "D"),
                build(++game, "MB", "QC", lane = 21, "A"), build(game, "BC", "NL", lane += 2, "B"), build(game, "SK", "SO", lane += 2, "C"), build(game, "NO", "AB", lane += 2, "D"),
                build(++game, "AB", "SO", lane = 21, "A"), build(game, "NO", "SK", lane += 2, "B"), build(game, "MB", "BC", lane += 2, "C"), build(game, "QC", "NL", lane += 2, "D"),
            });
